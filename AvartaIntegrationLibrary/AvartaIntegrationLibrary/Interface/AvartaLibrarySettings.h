...
@interface AvartaLibrarySettings : NSObject

/*!
@property pinLength
@discussion length of pin of current workflow for Avarta SDK pin register/verification
*/
...
/*!
 ...
 @property version
 @discussion last version of Avarta connect
 */
